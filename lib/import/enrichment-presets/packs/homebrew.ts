...
export const NECROMANCER_PRESETS: EnrichmentPreset[] = [
  ...
  },
  {
    ...
    operations: [
      ...
      {
        op: "attachNamedPreset",
        replaceCharacteristicTypes: ["inventory_container"],
        preset: {
          kind: "char_instance",
          idKey: "dead_space_container",
          ...
          characteristics: [
            {
              ...
              capacityAmount: 12,
              capacityLabel: "12 Medium or smaller corpses, piles of bones, or Undead",
  ...
  },
  {
    ...
    operations: [
      ...
      },
      {
        ...
        preset: {
          kind: "char_instance",
          idKey: "charnel_touch_attack",
          catalogRefId: "cat_char_special_attack",
          characteristics: [
            {
              id: "mod_charnel_touch_attack",
              type: "special_attack",
              ...
              label: "Melee spell attack · damage equals points spent · double on Critical Hit",
            },
            {
              id: "mod_charnel_touch_heal_thrall",
              type: "special_attack",
              ...
              damageDiceCount: 0,
              damageDieType: "d6",
              damageFromResourceSpend: false,
              healFromResourceSpend: true,
              healTarget: "controlled_companion",
              spendResourceOnHit: false,
              unlocksAtClassLevel: 2,
              label:
                "Touch an Undead thrall under your control — no attack roll; restore HP equal to points spent",
            },
          ],
        },
      },
