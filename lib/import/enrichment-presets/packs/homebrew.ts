...
export const NECROMANCER_PRESETS: EnrichmentPreset[] = [
  ...
  },
  {
    ...
    operations: [
      ...
      {
        op: "appendDescription",
        text: "Spend from class_resources.charnel_touch (5 × Necromancer level, long rest). Per-use cap is 5 × Proficiency Bonus; points are spent only on a hit, damage equals points spent, and a Critical Hit doubles that damage.",
      },
    ],
  },
  {
