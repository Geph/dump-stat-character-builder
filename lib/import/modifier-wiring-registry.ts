...
function formatMechanicsCheatsheet(): string {
  const lines = [
    ...
    "- attack_roll_modifiers: attackBonus 2, attackTarget all|melee|ranged; criticalHitMinimum; criticalHitMinimumByLevel [{ level, fixed: minD20 }]; ignoreHalfCover / treatThreeQuartersCoverAsHalf for cover-ignore phrasing (Zeroed Sights / Sharpshooter-style)",
