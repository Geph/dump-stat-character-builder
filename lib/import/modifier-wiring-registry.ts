...
export const HOMEBREW_WIRING_PATTERNS = [
  ...
  },
  {
    ...
    guidance: [
      ...
      "Charnel Touch feature: Magic action + class_resource limitedUses with classResourceKey \"charnel_touch\", classResourceAmount 5, classResourceCostMode \"up_to_proficiency_bonus\" (cap 5 × PB). Attach special_attack { attackProfile: \"melee\", damageType: \"Necrotic\", damageFromResourceSpend: true, spendResourceOnHit: true, criticalDamageMultiplier: 2 }. The sheet asks for points, deducts them only after Hit/Critical confirmation, and uses the selected points as flat damage.",
