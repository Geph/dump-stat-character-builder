...
export const HOMEBREW_WIRING_PATTERNS = [
  ...
  },
  {
    ...
    guidance: [
      ...
      "Trinkets are physical objects, so enrichment also emits one equipment[] row per trinket and a grant_equipment modifier on the same subclass Trinkets feature — the items land in inventory when the archetype level unlocks. Do not hand-author duplicate equipment rows for trinkets already named in the feature prose.",
  ...
  },
  {
    ...
    guidance: [
      ...
      "Dance Styles picker: isChoice + choices { category: \"Dance Style\", resourceKey: \"dance_styles_known\", optionsSource: \"class_upgrades\", choiceCountByLevel: [{level:2,count:1},{level:13,count:2}] }. Base styles are custom_abilities with ability_role \"upgrade\" (Agile Movement, Elegant Form, …). Subclass styles keep the \"[Dance Style]\" suffix on the feature name.",
