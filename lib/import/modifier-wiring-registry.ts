...
export const HOMEBREW_WIRING_PATTERNS = [
  ...
  },
  {
    ...
    guidance: [
      ...
      "Grand Finale / Encore / Misty Waltz alternate refresh: uses + alternateRefresh spendResourceKey dances.",
      ...
      "Deadly D4s: mechanics kind weapon_damage_die_override (dieSides 4, scope weapons) — enrichment also stubs this on Dervish Fighting.",
      "Momentum tokens: class_resources.momentum with subclass_name on the Momentum archetype (subclass-gated). Do not invent Momentum for every Dancer.",
...
function formatMechanicsCheatsheet(): string {
  const lines = [
    ...
    "- weapon_damage_die_override: dieSides 4 (Deadly D4s); weaponDamageScope weapons|melee|ranged|all|specific; optional weaponNames when specific. Rewrites NdX → Nd(sides) on equipped weapons — not a flat damage_roll_modifiers bonus.",
