...
export const HOMEBREW_WIRING_PATTERNS = [
  ...
  },
  {
    ...
    guidance: [
      ...
      "Dire Gambit: regain 1 Risk Die on Initiative → uses.rechargeOnInitiative: 1 only when Dire Gambit is present (enrichment sets/strips this). Do not put rechargeOnInitiative on Risk Dice from the level table alone.",
  ...
  },
  {
    ...
    guidance: [
      ...
      "Empowered Endurance: regain 1 Endurance Die on Initiative when none remain → uses.rechargeOnInitiative: 1 (enrichment sets/strips this; do not set from the level table alone).",
