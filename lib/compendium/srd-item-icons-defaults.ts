...
export const SRD_FEAT_ICONS_BY_NAME: Record<string, string> = {
  ...
  "Mounted Combatant": "cloaked-figure-on-horseback",
  Musician: "music-spell",
  Observant: "observatory",
  "Outlands Envoy": "trail",
  Piercer: "pierced-body",
  "Planar Wanderer": "shiny-omega",
  ...
  "Scion of the Outer Planes": "knocked-out-stars",
  "Second Skin": "werewolf",
