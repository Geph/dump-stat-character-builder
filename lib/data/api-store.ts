/**
 * Browser-side API data client for hosted deployments.
 * Talks to /api/data/* and /api/characters; the server uses MySQL.
 */

import { resolveTable } from "@/lib/db/tables"
import type { DbResult, Filter, QueryBuilder } from "./types"
