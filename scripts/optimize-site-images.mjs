 ...
 * Bundled origins (SRD) win over Mage Hand Press / Kibbles / PHB / MotM / extra when slugs collide.
 */
 ...
 * Prefer SRD over Mage Hand Press / Kibbles / `extra/` when the same subclass slug appears in both.
 */
