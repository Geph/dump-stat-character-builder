    ...
    <footer id={id} className={className ?? "mt-auto shrink-0 w-full py-5 px-4 border-t border-border bg-card"}>
      <div className="max-w-6xl mx-auto">
        <Accordion type="single" collapsible>
          <AccordionItem value="attribution-legal" className="border-none">
            <AccordionTrigger className="py-2 text-sm font-medium text-muted-foreground hover:no-underline hover:text-foreground justify-center gap-2 [&>svg]:size-3.5">
              Attribution and Legal
            </AccordionTrigger>
            <AccordionContent>
              <div className="text-center text-muted-foreground text-sm space-y-2 pt-1">
