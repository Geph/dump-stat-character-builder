...
import { FontAttribution } from "@/components/font-attribution"
import { CC_BY_SA_4_URL } from "@/lib/fonts/solbera-attribution"
        ...
        >
          <div className="overflow-hidden">
            <div className="text-center text-muted-foreground text-sm space-y-2 pb-4">
              ...
              <FontAttribution className="text-left sm:text-center max-w-4xl mx-auto" />
              <p className="text-xs leading-snug">
        ...
        <div className="flex w-full flex-col items-center gap-1 py-2">
          ...
          {!open ? (
            <p className="text-[11px] font-normal leading-snug text-muted-foreground">
              SRD 5.2.1 (CC BY 4.0) · Solbera&apos;s D&amp;D Fonts (
              <a
                href={CC_BY_SA_4_URL}
                target="_blank"
                rel="noopener noreferrer"
