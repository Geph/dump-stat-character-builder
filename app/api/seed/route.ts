...
const SRD_SUBCLASSES = [
  {
    ...
    features: [
      { level: 3, name: "Frenzy", description: "You can go into a frenzy when you rage. If you do so, for the duration of your rage you can make a single melee weapon attack as a bonus action on each of your turns after this one." },
  ...
  },
  {
    ...
    features: [
      ...
      { level: 3, name: "Cutting Words", description: "You can use your wit to distract, confuse, and otherwise sap the confidence and competence of others." },
      { level: 6, name: "Additional Magical Secrets", description: "You learn two spells of your choice from any class." },
      { level: 14, name: "Peerless Skill", description: "When you make an ability check, you can expend one use of Bardic Inspiration to add the roll to your ability check." },
    ],
    source: "SRD",
  },
  {
    ...
    features: [
      ...
      { level: 1, name: "Disciple of Life", description: "Your healing spells are more effective. Whenever you use a spell of 1st level or higher to restore hit points, the creature regains additional hit points equal to 2 + the spell's level." },
  ...
  },
  {
    ...
    features: [
      ...
      { level: 2, name: "Natural Recovery", description: "During a short rest, you can recover some spell slots." },
      ...
      { level: 10, name: "Nature's Ward", description: "You can't be charmed or frightened by elementals or fey." },
  ...
  },
  {
    ...
    features: [
      ...
      { level: 18, name: "Survivor", description: "You attain the pinnacle of resilience in battle. At the start of each of your turns, you regain hit points." },
    ],
    source: "SRD",
  },
  {
    ...
    features: [
      { level: 3, name: "Open Hand Technique", description: "You can manipulate your enemy's ki when you harness your own." },
  ...
  },
  {
    ...
    features: [
      { level: 3, name: "Oath Spells", description: "You gain oath spells at the paladin levels listed." },
      { level: 3, name: "Channel Divinity: Sacred Weapon", description: "You can imbue one weapon with positive energy." },
      { level: 3, name: "Channel Divinity: Turn the Unholy", description: "You can use your Channel Divinity to turn fiends and undead." },
      ...
      { level: 20, name: "Holy Nimbus", description: "As an action, you can emanate an aura of sunlight." },
    ],
    source: "SRD",
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { level: 13, name: "Use Magic Device", description: "You can use any magic item, regardless of class, race, or level requirements." },
  ...
  },
  {
    ...
    features: [
      { level: 1, name: "Dragon Ancestor", description: "You choose one type of dragon as your ancestor." },
      { level: 1, name: "Draconic Resilience", description: "Your hit point maximum increases by 1 for each sorcerer level, and you gain a natural AC of 13 + Dexterity modifier." },
      ...
      { level: 14, name: "Dragon Wings", description: "You gain the ability to sprout a pair of dragon wings from your back." },
      { level: 18, name: "Draconic Presence", description: "You can channel the dread presence of your dragon ancestor." },
    ],
    source: "SRD",
  },
  {
    ...
    features: [
      ...
      { level: 6, name: "Dark One's Own Luck", description: "You can call on your patron to alter fate in your favor." },
      { level: 10, name: "Fiendish Resilience", description: "You can choose one damage type when you finish a short or long rest. You gain resistance to that damage type." },
  ...
  },
  {
    ...
    features: [
      ...
      { level: 14, name: "Overchannel", description: "You can increase the power of your simpler spells." },
    ],
    source: "SRD",
  },
]
  ...
  try {
    ...
    return NextResponse.json({ 
      ...
      breakdown: {
        ...
        subclasses: SRD_SUBCLASSES.length,
